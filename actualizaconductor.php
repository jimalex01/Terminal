...
$query="select * from conductores where documento='$documento'";
$resultado= $conexion->query($query);
$row=$resultado->fetch_assoc();
?>
<form action="actualizacondu.php?documento=<?php echo $row['DOCUMENTO'];?>" method="post">
<section class="col-xs-12 col-sm-12 col-md-12 col-lg-12">            
<legend class="text-center header">MODIFICAR CONDUCTORES</legend>
...
<center><table>
    ...
    <td><strong><input type="text" value="<?php echo $row['DIRECCION'];?>" name="direccion" REQUIRED/></strong></td>
    ...
    <br>
    <div class="button">
        <center><button type="submit">MODIFICAR CONDUCTORES</button></center>
    </div>
    <br>
<br>
<br>
