...
<section>
	<div class=" caja1 col-xs-12 col-sm-12 col-md-12 col-lg-8"> 
		...
		<div class="carousel-inner" role="listbox">
			<div class="item active">
				<img src="images/terminal11.jpg" class="img-responsive" alt="">
			</div>

			<div class="item">
				<img src="images/terminal10.jpg" class="img-responsive" alt="">
				
			</div>

			<div class="item">
				<img src="images/terminal40.jpg" class="img-responsive" alt="">
	...
	<div class=" caja2 col-xs-12 col-sm-12 col-md-12 col-lg-4">
		 ...
		 <div class="form-group">
			 <label for="nombre"><h2>Bienvenidos Clientes</h2></label>
                       
				
			 <input class="form-control" id="documento" name="username" type="text" required="" placeholder="Username">
		 </div>
		 <div class="form-group">
		 ...
		 <center><center><input name="submit" type="submit" value="Ingresar">
		 </form>
                 <span><?php echo $error; ?></span>
		  <button class="btn"><a class="" href="registro.php" style="text-decoration:none; color:#000000"> Registrarse</a></button></center>
